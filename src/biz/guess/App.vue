<template>
  <div id="guess"
    ...
    <History :history="rspData.guessHistory">
    </History>
    ...
    <div class="to-link-img"
         @click="goOutLink">
      <img src="//h0.beicdn.com/open/201825/a62b3cf61dc10af2_750x200.png"
           alt="">
    </div>
    <Ad :items="adData"></Ad>
    <LangChaneCard></LangChaneCard>
  </div>
...
import LangChaneCard from './components/LangChangeCard.vue';
...
export default {
  ...
  created () {
    // this.message = this.$t("message.grade");
    // this.$i18n.locale = "en";
