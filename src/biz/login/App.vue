<template>
    <div id="movie">
        ...
        <div class="account_form">
                <input type="text" class="account_btn" value="" id="username" placeholder="手机号/邮箱" v-model="username">
                <input type="password" class="password_btn" value="" id="password" placeholder="密码" v-model="password">
            </div>
            <div class="">
